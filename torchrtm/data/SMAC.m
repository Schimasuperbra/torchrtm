function Opt_atm = SMAC(angles,atm,coef)
%=============================================================================================
...
if isempty(atm.Pa)||atm.Pa0==-999 %if ~isempty(atm.Pa)||atm.Pa0~=-999
    ...
    % Example of a debug statement for a computed value
    us = cos(tts * pi / 180);
    uv = cos(tto * pi / 180);
    ...
    disp(["Peq: ", num2str(Peq)]);
    disp(["po2: ", num2str(po2)]);
    disp(["uo2: ", num2str(uo2)]);
    disp(["uco2: ", num2str(uco2)]);
    disp(["uch4: ", num2str(uch4)]);
    disp(["uno2: ", num2str(uno2)]);
    disp(["uco: ", num2str(uco)]);
    ...
    disp(["to3: ", num2str(to3)]);
    disp(["th2o: ", num2str(th2o)]);
    disp(["to2: ", num2str(to2)]);
    disp(["tco2: ", num2str(tco2)]);
    disp(["tch4: ", num2str(tch4)]);
    disp(["tno2: ", num2str(tno2)]);
    disp(["tco: ", num2str(tco)]);

    tg = th2o .* to3 .* to2 .* tco2 .* tch4 .* tco .* tno2; %Eq. 6
    disp(["Total gaseous transmission (tg): ", num2str(tg)]);

    %-------5) spherical albedo of the atmosphere Eq. 7------------------------
    s = (a0s) * Peq +  (a3s) + (a1s)*taup550 + (a2s) * (taup550 .^ 2);
    disp(["Spherical albedo (s): ", num2str(s)]);
    ...
    disp(["cksi: ", num2str(cksi)]);
    disp(["psi: ", num2str(psi)]);
    disp(["cdr: ", num2str(cdr)]);
    ...
    disp(["taur: ", num2str(taur)]);
    disp(["ray_phase: ", num2str(ray_phase)]);
    disp(["us: ", num2str(us)]);
    disp(["uv: ", num2str(uv)]);
    ...
    disp(["ray_ref: ", num2str(ray_ref)]);
    disp(["Res_ray: ", num2str(Res_ray)]);
    disp(["aer_ref: ", num2str(aer_ref)]);
    disp(["Res_aer: ", num2str(Res_aer)]);
    disp(["Res_6s: ", num2str(Res_6s)]);
    ...
    disp(["ttetas: ", num2str(ttetas)]);
    disp(["ttetav: ", num2str(ttetav)]);
    disp(["tg: ", num2str(tg)]);
    disp(["s: ", num2str(s)]);
    disp(["atm_ref: ", num2str(atm_ref)]);





    disp(["tdir_tts: ", num2str(tdir_tts)]);
    disp(["tdir_ttv: ", num2str(tdir_ttv)]);
    disp(["tdif_tts: ", num2str(tdif_tts)]);
    disp(["tdif_ttv: ", num2str(tdif_ttv)]);
